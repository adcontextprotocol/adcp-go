...
// AdCP schema version: 3.2.0-beta.9
...
func KnownSpecialismValues() []Specialism {
	return []Specialism{SpecialismAudienceSync, SpecialismBrandRights, SpecialismCollectionLists, SpecialismContentStandards, SpecialismCreativeAdServer, SpecialismCreativeGenerative, SpecialismCreativeTemplate, SpecialismCreativeTransformers, SpecialismGovernanceAwareSeller, SpecialismGovernanceDeliveryMonitor, SpecialismGovernanceSpendAuthority, SpecialismPropertyLists, SpecialismSalesBroadcastTv, SpecialismSalesCatalogDriven, SpecialismSalesGuaranteed, SpecialismSalesNonGuaranteed, SpecialismSalesProposalMode, SpecialismSalesSocial, SpecialismSignalMarketplace, SpecialismSignalOwned, SpecialismSignedRequests, SpecialismSponsoredIntelligence}
}
...
type PackageDelivery struct {
	...
	Currency                           string                          `json:"currency"`                                         // ISO 4217 currency code for this package's pricing rate and spend. For
