...
// AdCP schema version: 3.2.0-rc.1
...
func KnownSpecialismValues() []Specialism {
	return []Specialism{SpecialismAudienceSync, SpecialismBrandRights, SpecialismCollectionLists, SpecialismContentStandards, SpecialismCreativeAdServer, SpecialismCreativeGenerative, SpecialismCreativeTemplate, SpecialismCreativeTransformers, SpecialismGovernanceAwareSeller, SpecialismGovernanceDeliveryMonitor, SpecialismGovernanceSpendAuthority, SpecialismPropertyLists, SpecialismSalesBroadcastTv, SpecialismSalesCatalogDriven, SpecialismSalesDooh, SpecialismSalesGuaranteed, SpecialismSalesNonGuaranteed, SpecialismSalesProposalMode, SpecialismSalesSocial, SpecialismSignalMarketplace, SpecialismSignalOwned, SpecialismSignedRequests, SpecialismSponsoredIntelligence}
}
...
type ProductFilters struct {
	...
	// Deprecated: DEPRECATED.
	Countries []string `json:"countries,omitempty"` // DEPRECATED. Use get_products.targeting_overlay.geo_countries so returned
	// Deprecated: DEPRECATED.
	Regions []string `json:"regions,omitempty"` // DEPRECATED. Use get_products.targeting_overlay.geo_regions. Sellers resolve
	// Deprecated: DEPRECATED.
	Metros                  []ProductFilterMetro     `json:"metros,omitempty"`                    // DEPRECATED. Use get_products.targeting_overlay.geo_metros for known values or
	...
	// Deprecated: DEPRECATED.
	SignalTargeting []SignalTargeting `json:"signal_targeting,omitempty"` // DEPRECATED. Use get_products.targeting_overlay.signal_targeting_groups for
	// Deprecated: DEPRECATED.
	PostalAreas []PostalArea `json:"postal_areas,omitempty"` // DEPRECATED. Use get_products.targeting_overlay.geo_postal_areas for known
	// Deprecated: DEPRECATED.
	GeoProximity                 []ProductFilterGeoProximity `json:"geo_proximity,omitempty"`                  // DEPRECATED. Use get_products.targeting_overlay.geo_proximity. Sellers resolve
	...
	// Deprecated: DEPRECATED.
	Keywords                     []ProductFilterKeyword        `json:"keywords,omitempty"`                       // DEPRECATED. Use get_products.targeting_overlay.keyword_targets for concrete
...
// Targeting — Concrete delivery constraints used during product discovery and media-buy execution. Targeting
...
type PackageInput struct {
	...
	Catalogs                     []Catalog                     `json:"catalogs,omitempty"`                       // Catalogs this package promotes. Each catalog MUST have a distinct type (e.g.
	OptimizationGoals            []OptimizationGoal            `json:"optimization_goals,omitempty"`             // Optimization targets for this package. The seller optimizes delivery toward
	TargetingOverlay             *Targeting                    `json:"targeting_overlay,omitempty"`              // Optional package-specific targeting that further constrains targeting already
...
type PackageUpdate struct {
	...
	TargetingOverlay       *Targeting            `json:"targeting_overlay,omitempty"`        // Complete effective targeting overlay to apply to this package. On update, this
...
type GetProductsRequest struct {
	...
	// Deprecated: DEPRECATED in favor of adcp_version (release-precision string).
	AdcpMajorVersion       int                     `json:"adcp_major_version,omitempty"`       // DEPRECATED in favor of adcp_version (release-precision string). Servers MUST
	IdempotencyKey         string                  `json:"idempotency_key,omitempty"`          // Optional client-generated key for retry-safe use of the AdCP 3.x compatibility
	...
	PropertyList           *PropertyListRef        `json:"property_list,omitempty"`             // DEPRECATED discovery-only property filter. Use targeting_overlay.property_list
...
type MCPWebhookPayload struct {
	...
	ContextID      string       `json:"context_id,omitempty"`      // Session/conversation correlation identifier. This value alone is not
