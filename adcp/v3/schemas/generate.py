...
SCHEMA_32_RC_ANY_FIELDS = {
    ...
    ('SyncReportingReceiptsRequest', 'adcp_major_version'),
    ('SyncReportingReceiptsResponse', 'results'),
    ('SyncReportingStatusRequest', 'adcp_major_version'),
    ('SyncReportingStatusResponse', 'results'),
