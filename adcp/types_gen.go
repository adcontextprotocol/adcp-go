...
type Package struct {
	...
	CommittedMetrics []string `json:"committed_metrics,omitempty"` // Frozen snapshot of the product's `reporting_capabilities.available_metrics` at t
	CommittedVendorMetrics []any `json:"committed_vendor_metrics,omitempty"` // Frozen snapshot of the product's `reporting_capabilities.vendor_metrics` at the 
