...
func KnownErrorCodeValues() []ErrorCode {
	return []ErrorCode{ErrorCodeINVALIDREQUEST, ErrorCodeAUTHREQUIRED, ErrorCodeAUTHMISSING, ErrorCodeAUTHINVALID, ErrorCodeAUTHORIZATIONREQUIRED, ErrorCodeRATELIMITED, ErrorCodeSERVICEUNAVAILABLE, ErrorCodeCONFIGURATIONERROR, ErrorCodePOLICYVIOLATION, ErrorCodePRODUCTNOTFOUND, ErrorCodePRODUCTUNAVAILABLE, ErrorCodePROPOSALEXPIRED, ErrorCodeBUDGETTOOLOW, ErrorCodeCREATIVEREJECTED, ErrorCodeCREATIVEVALUENOTALLOWED, ErrorCodeUNSUPPORTEDFEATURE, ErrorCodeUNPRICEABLEOUTPUT, ErrorCodeUNSUPPORTEDGRANULARITY, ErrorCodeUNSUPPORTEDPROVISIONING, ErrorCodeAUDIENCETOOSMALL, ErrorCodeACCOUNTNOTFOUND, ErrorCodeACCOUNTSETUPREQUIRED, ErrorCodeACCOUNTAMBIGUOUS, ErrorCodeACCOUNTPAYMENTREQUIRED, ErrorCodeACCOUNTSUSPENDED, ErrorCodeCOMPLIANCEUNSATISFIED, ErrorCodeGOVERNANCEDENIED, ErrorCodeBUDGETEXHAUSTED, ErrorCodeBUDGETEXCEEDED, ErrorCodeBUDGETCAPREACHED, ErrorCodeCONFLICT, ErrorCodeIDEMPOTENCYCONFLICT, ErrorCodeIDEMPOTENCYEXPIRED, ErrorCodeIDEMPOTENCYINFLIGHT, ErrorCodeCREATIVEDEADLINEEXCEEDED, ErrorCodeCREATIVEINACCESSIBLE, ErrorCodeINVALIDSTATE, ErrorCodeMEDIABUYNOTFOUND, ErrorCodeNOTCANCELLABLE, ErrorCodePACKAGENOTFOUND, ErrorCodeCREATIVENOTFOUND, ErrorCodeSIGNALNOTFOUND, ErrorCodeSIGNALTARGETINGINCOMPATIBLE, ErrorCodeSESSIONNOTFOUND, ErrorCodePLANNOTFOUND, ErrorCodeREFERENCENOTFOUND, ErrorCodeSESSIONTERMINATED, ErrorCodeVALIDATIONERROR, ErrorCodePRODUCTEXPIRED, ErrorCodePROPOSALNOTCOMMITTED, ErrorCodePROPOSALNOTFOUND, ErrorCodeMULTIFINALIZEUNSUPPORTED, ErrorCodeIOREQUIRED, ErrorCodeTERMSREJECTED, ErrorCodeREQUOTEREQUIRED, ErrorCodeVERSIONUNSUPPORTED, ErrorCodeCAMPAIGNSUSPENDED, ErrorCodeGOVERNANCEUNAVAILABLE, ErrorCodePERMISSIONDENIED, ErrorCodeSCOPEINSUFFICIENT, ErrorCodeREADONLYSCOPE, ErrorCodeFIELDNOTPERMITTED, ErrorCodePROVENANCEREQUIRED, ErrorCodePROVENANCEDIGITALSOURCETYPEMISSING, ErrorCodePROVENANCEDISCLOSUREMISSING, ErrorCodePROVENANCEEMBEDDEDMISSING, ErrorCodePROVENANCEVERIFIERNOTACCEPTED, ErrorCodePROVENANCECLAIMCONTRADICTED, ErrorCodeEVALUATORAGENTNOTACCEPTED, ErrorCodeBILLINGNOTSUPPORTED, ErrorCodeBILLINGNOTPERMITTEDFORAGENT, ErrorCodeBILLINGOUTOFBAND, ErrorCodePAYMENTTERMSNOTSUPPORTED, ErrorCodeBRANDREQUIRED, ErrorCodeAGENTSUSPENDED, ErrorCodeAGENTBLOCKED, ErrorCodeCREDENTIALINARGS, ErrorCodeACTIONNOTALLOWED, ErrorCodePRIVATEFIELDINPUBLICPLACEMENT, ErrorCodeFORMATPROJECTIONFAILED, ErrorCodeFORMATDECLARATIONDIVERGENT, ErrorCodeFORMATDECLARATIONV1AMBIGUOUS, ErrorCodeFORMATOPTIONUNRESOLVED, ErrorCodeFORMATDECLARATIONV1LOSSYMULTISIZE, ErrorCodeFORMATNOTSUPPORTED, ErrorCodePIXELTRACKERLOSSYDOWNGRADE, ErrorCodePIXELTRACKERUPGRADEINFERRED, ErrorCodeSTALERESPONSE, ErrorCodeFEEDFETCHFAILED, ErrorCodeINVALIDFEEDFORMAT, ErrorCodeITEMVALIDATIONFAILED, ErrorCodeCATALOGLIMITEXCEEDED}
}
...
func KnownTaskTypeValues() []TaskType {
	return []TaskType{TaskTypeCreateMediaBuy, TaskTypeUpdateMediaBuy, TaskTypeMediaBuyDelivery, TaskTypeSyncCreatives, TaskTypeBuildCreative, TaskTypeActivateSignal, TaskTypeGetProducts, TaskTypeGetSignals, TaskTypeCreatePropertyList, TaskTypeUpdatePropertyList, TaskTypeGetPropertyList, TaskTypeListPropertyLists, TaskTypeDeletePropertyList, TaskTypeSyncAccounts, TaskTypeGetAccountFinancials, TaskTypeGetCreativeDelivery, TaskTypeSyncEventSources, TaskTypeSyncAudiences, TaskTypeSyncCatalogs, TaskTypeLogEvent, TaskTypeGetBrandIdentity, TaskTypeSearchBrands, TaskTypeGetRights, TaskTypeAcquireRights}
}
...
type ProductFilters struct {
	...
	PublisherDomain              string                                 `json:"publisher_domain,omitempty"`               // Filter to products whose publisher_properties include the specified publisher
...
type ActivateSignalRequest struct {
	...
	GovernanceContext    string             `json:"governance_context,omitempty"` // Opaque governance context returned by check_governance for this signal
