...
type ContextMatchRequest struct {
	...
	SellerAgentURL   string          `json:"seller_agent_url"`             // API endpoint URL of the seller agent issuing this request. The provider resolves the active package set it has synced for this seller against it. Manual ahead-of-bundle stub for adcontextprotocol/adcp#5410; regenerates identically once adcp/schemas/VERSION pins a bundle containing the field.
